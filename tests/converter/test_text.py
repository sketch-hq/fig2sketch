...
class TestOverrideStyles:
    def test_plain_text(self):
        ...
        assert attr.MSAttributedStringFontAttribute == FontDescriptor(name='Roboto-Normal', size=12)
    ...
    def test_emoji_text(self):
        ...
        assert c0.location == 0
        assert c0.length == 7
        assert c0.attributes.MSAttributedStringFontAttribute == FontDescriptor(name='Roboto-Normal', size=12)

        assert c1.location == 7
        assert c1.length == 1
        assert c1.attributes.MSAttributedStringFontAttribute == FontDescriptor(name='AppleColorEmoji', size=9)
